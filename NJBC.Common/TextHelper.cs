...
namespace NJBC.Common
{
    public class TextHelper : IDisposable
    {
        ...
        {
            return input.Replace("۰", "0").Replace("۱", "1").Replace("۲", "2").Replace("۳", "3").Replace("۴", "4").Replace("۵", "5").Replace("٥", "5").Replace("۶", "6").Replace("v", "7").Replace("۸", "8").Replace("۹", "9").Replace("۷", "9");
        }
        ...
        public string CleanReview(string text)
        {
            ...
            _txt = _txt
                            ...
                            .Replace("خییییلی", "خیلی").Replace("خیییلی", "خیلی").Replace("خییلی", "خیلی")
                            .Replace("خیلییییی", "خیلی").Replace("خیلیییی", "خیلی").Replace("خیلییی", "خیلی").Replace("خیلییی", "خیلی")
                            ...
                            .Replace("گرفت.","گرفت. ").Replace("رفتم.","رفتم. ")
                            ...
                            .Replace("!\n\r", ". ").Replace("!\r\n", ". ").Replace("!\n", ". ").Replace("!<br>", ". ")
                                                ...
                                                .Replace(" ، ، ", " ، ").Replace("،،", " ، ").Replace("  ", " ").Replace("  ", " ")
                                                .Trim();
            _txt = _txt.Replace(". .", ". ").Replace("؟ .", "؟ ").Replace("؟ ؟", "؟").Replace("؟ ؟", "؟").Trim();
