...
namespace NJBC.Common
{
    public class TextHelper : IDisposable
    {
        ...
        private string CleanDate(string text)
        {
            ...
            .Replace("0هفته", "0 هفته")
            .Replace("1هفته", "1 هفته")
            .Replace("2هفته", "2 هفته")
            .Replace("3هفته", "3 هفته")
            .Replace("4هفته", "4 هفته")
            .Replace("5هفته", "5 هفته")
            .Replace("6هفته", "6 هفته")
            .Replace("7هفته", "7 هفته")
            .Replace("8هفته", "8 هفته")
        ...
        {
            return text.Replace("0درصد", "0 درصد")
            .Replace("1درصد", "1 درصد")
            .Replace("2درصد", "2 درصد")
            .Replace("3درصد", "3 درصد")
            .Replace("4درصد", "4 درصد")
            .Replace("5درصد", "5 درصد")
            .Replace("6درصد", "6 درصد")
            .Replace("7درصد", "7 درصد")
            .Replace("8درصد", "8 درصد")
            .Replace("9درصد", "9 درصد");
        }
        ...
        public bool RemoveSingleEmoji(string text)
        {
            if (Emojis.Equals(text.Trim()))
                return true;
            else if (string.IsNullOrEmpty(RemoveEmoji(text)))
                return true;
            else
                return false;
        }

        private string removeDot(string txt)
        {
            txt = txt
            .Replace(".................................", " . ")
            .Replace("................................", " . ")
        ...
        public string CleanReview(string text)
        {
            ...
            .Replace("ییی", "ی")
            .Replace("ییی", "ی")
            .Replace("خییییلی", "خیلی")
            .Replace("خیییلی", "خیلی")
            .Replace("خییلی", "خیلی")
            .Replace("خیلییییی", "خیلی")
            .Replace("خیلیییی", "خیلی")
            .Replace("خیلییی", "خیلی")
            .Replace("خیلییی", "خیلی")
            .Replace("هههه", "ه")
            .Replace("ههه", "ه")
            ...
            .Replace("کنیم؟", "کنیم؟ ")
            .Replace("کنیم.", "کنیم. ")
            .Replace("بارداری.", "بارداری. ")
            .Replace("پریودم.", "پریودم. ")
            .Replace("دوره ام.", "دوره ام. ")
            .Replace("پرید.", "پرید. ")
            .Replace("پریدم.", "پریدم. ")
            .Replace("برید.", "برید. ")
            .Replace("بریدم.", "بریدم. ")
            ...
            .Replace("نشه.", "نشه. ")
            .Replace("نشه؟", "نشه؟ ")
            .Replace("عااااااااالیه", "عالیه")
            .Replace("عاااااااالیه", "عالیه")
            .Replace("عاااااااالیه", "عالیه")
            .Replace("عااااااالیه", "عالیه")
            .Replace("عااااالیه", "عالیه")
            .Replace("عالیههههههههه", "عالیه")
            .Replace("عالیهههههههه", "عالیه")
            .Replace("عالیههههههه", "عالیه")
            .Replace("عالیهههههه", "عالیه")
            .Replace("عالیههههه", "عالیه")
            .Replace("عالیهههه", "عالیه")
            .Replace("عالیههه", "عالیه")
            .Replace("عالیهه", "عالیه")
            .Replace("عالیهه", "عالیه")
            .Replace("عالیه.", "عالیه. ")
            .Replace("داره.", "داره. ")
            .Replace("داره؟", "داره؟ ")
            ...
            .Replace(" . ", ". ")
            .Replace(" . ", ". ")
            .Replace("دیجی کالا", "دیجیکالا")
            .Replace("دیجیکلا ", "دیجیکالا")
            .Replace("دجی کالا", "دیجیکالا")
            .Replace("دیج کالا", "دیجیکالا")
            .Replace("  ", " ")
            .Replace("  ", " ")
            .Replace("  ", " ")
            .Replace(" ، ، ", " ، ")
